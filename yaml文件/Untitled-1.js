...
const ruleProviderCommon = {
  ...
  function main(config) {
    ...
    config["proxy-groups"] = [
      { 
        ...groupBaseOption,
        "name": "🌐 手动节点", "type": "select", "include-all": true, "exclude-filter": "(?i)距离|节点|超时|官网|剩余|套餐|最新|机场|故障|流量|到期|收藏|过期",},
      { 
        ...groupBaseOption,
        "name": "♻️ 自动选择", "type": "url-test", "include-all": true, "exclude-filter": "(?i)距离|节点|超时|官网|剩余|套餐|最新|机场|故障|流量|到期|收藏|过期|直连|direct",},
      {
        ...groupBaseOption,
        "name": "国际媒体",
        "type": "select",
